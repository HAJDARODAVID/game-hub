    ...
    <div class="d-flex align-items-start flex-column" style="height: 200%;">
        ...
        <div class="mt-auto w-100">
            <div class="form-group d-flex align-items-center gap-2 mt-2">
                ...
                <button class="btn btn-dark shadow" style="border-radius: 0px !important;" wire:click='sendNewMessage()' x-on:click="$refs.scrollableDiv.scrollTop = ($refs.scrollableDiv.scrollHeight+999)"><i class="bi bi-send"></i></button>
            </div>
        </div>
      </div>
</div>
